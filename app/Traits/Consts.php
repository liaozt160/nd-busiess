...
class Consts {
    ...
    const ORDER_STATUS_INFO_UNPAID = 0;
    const ORDER_STATUS_INFO_PAID_PENDING = 1;
    const ORDER_STATUS_INFO_PAID_VERIFICATION = 2;
    const ORDER_STATUS_INFO_PAID_INVALIDATE = 3;
    const ORDER_STATUS_INSPECT_UNPAID = 4;
    const ORDER_STATUS_INSPECT_PAID_PENDING = 5;
    const ORDER_STATUS_INSPECT_PAID_VERIFICATION = 6;
    const ORDER_STATUS_INSPECT_PAID_INVALIDATE = 7;

    const ORDER_PAYMENT_INFO = 1;
    const ORDER_PAYMENT_INSPECT = 2;
